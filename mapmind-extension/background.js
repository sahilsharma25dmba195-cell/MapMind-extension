...
- Region: EXACT-Global, North America, South America, Rest of Europe, European Union, Africa, Middle East, Asia, Russia, United Kingdom, Australia Oceania. Single best-fit.

CRITICAL GEOGRAPHY RULE:

If a country is mentioned together with a region that is NOT its own geographic region,
DO NOT assign that region to the country.

Instead:
- If interaction spans different regions → region = "Global"
- Use "countries" if multiple actors are clearly involved
- If unclear → use only "Global" without country

Example:
- US involvement in Middle East → region = "Global", countries = ["United States", "Iran"] (if Iran is central)
- US policy affecting Middle East → region = "Global"
